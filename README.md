![docker image](https://github.com/Bondoki/tmp-nomad-docker-v1.4.2b/actions/workflows/docker-publish.yml/badge.svg)
...
2. Clone the repository or download the repository as a zip file.
    ...
    ```sh
    git clone https://github.com/Bondoki/tmp-nomad-docker-v1.4.2b.git
    cd tmp-nomad-docker-v1.4.2b
    ```

    or

    ```sh
    curl-L -o tmp-nomad-docker-v1.4.2b.zip "https://github.com/Bondoki/tmp-nomad-docker-v1.4.2b/archive/main.zip"
    unzip tmp-nomad-docker-v1.4.2b.zip
    cd tmp-nomad-docker-v1.4.2b
    ```
...
your `docker-compose.yaml` with `ghcr.io/bondoki/tmp-nomad-docker-v1.4.2b:main` for the services
...
```sh
docker pull ghcr.io/bondoki/tmp-nomad-docker-v1.4.2b/jupyter:main
```
...
_I get an_ `Error response from daemon: Head "https://ghcr.io/v2/Bondoki/tmp-nomad-docker-v1.4.2b/manifests/main": unauthorized`
